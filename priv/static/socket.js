...
Combo.Socket = (() => {
  ...
  var comboWindow = typeof window !== "undefined" ? window : null;
  var global = globalSelf || comboWindow || globalThis;
  ...
  var AUTH_TOKEN_PREFIX = "base64url.bearer.combo.";
  ...
  var Socket = class {
    ...
    ping(callback) {
      ...
      this.push({ topic: "combo", event: "heartbeat", payload: {}, ref });
  ...
  return __toCommonJS(socket_exports);
})();
