defmodule Combo.ConnTest do
  ...
  most commonly your application endpoint itself.
  ...
  since the controller in Combo plays an integration role between your
  ...
  Keep in mind Combo will automatically recycle the connection between
  ...
  Useful for extracting path params out of returned URLs.
