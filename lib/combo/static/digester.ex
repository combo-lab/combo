defmodule Combo.Static.Digester do
  @moduledoc false
  ...
  @comment "This file was auto-generated by `mix combo.static.digest`. Remove it and all generated artefacts with `mix combo.static.clean --all`"

  defp write_manifest(latest, digests, output_path) do
    encoder = Combo.json_module()
  ...
  defp compressed_extensions do
    Enum.flat_map(Combo.Static.compressors(), & &1.file_extensions())
  end
  ...
  defp write_to_disk(file, output_path) do
    ...
    Enum.each(Combo.Static.compressors(), fn compressor ->
