defmodule Combo.SocketTest do
  use ExUnit.Case, async: true

  import Combo.Socket
  alias Combo.Socket.{Message, InvalidMessageError}
  ...
  describe "__info__/2" do
    ...
    test "disconnect broadcast emits close code 1001 so Combo JS client reconnects" do
      # Combo JS client gates reconnects on `closeCode !== 1000`.
      ...
      assert {:stop, {:shutdown, :disconnected}, 1001, ^state} =
               Combo.Socket.__info__(msg, state)
    end
  end
end
