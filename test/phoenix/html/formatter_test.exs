defmodule Combo.HTML.FormatterTest do
  ...
  defp assert_formatter_output(input, expected, dot_formatter_opts \\ []) do
    ...
    first_pass = Formatter.format(input, dot_formatter_opts) |> IO.iodata_to_binary()
    assert first_pass == expected

    second_pass = Formatter.format(first_pass, dot_formatter_opts) |> IO.iodata_to_binary()
  ...
  def assert_formatter_doesnt_change(code, dot_formatter_opts \\ []) do
    ...
    first_pass = Formatter.format(code, dot_formatter_opts) |> IO.iodata_to_binary()
