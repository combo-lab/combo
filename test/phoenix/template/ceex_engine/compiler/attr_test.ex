...
defmodule Phoenix.Template.CEExEngine.Compiler.AttrTest do
  ...
  describe "local - optimizes lists" do
    test ~S'like ["static1", "static2", "static3"] by inline static elements' do
      assert {:attr, "class", ["static1 static2 static3"]} =
               handle_attr({:local, "class", quote(do: ["static1", "static2", "static3"])})
    end

    test ~S'like ["static1", "static2", dynamic1, "static3"] by splitting static and dynamic elements' do
      assert {:attr, "class",
              [
                "static1 static2 ",
                {:safe,
                 {{:., [line: 1], [_module, :escape_value]}, [line: 1],
                  [
                    [
                      {:dynamic1, [], __MODULE__},
                      "static3"
               ...
               handle_attr(
                 {:local, "class", quote(do: ["static1", "static2", dynamic1, "static3"])}
               )
    end
  end
