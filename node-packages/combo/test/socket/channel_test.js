...
import { Channel, Socket } from "../../src/socket"
...
describe("with transport", function () {
  ...
  describe("constructor", function () {
    ...
    it("sets subprotocols when authToken is a function", function () {
      ...
      authToken = "5678"
      socket.connect()
      expect(socket.conn.protocols).toEqual(["combo", "base64url.bearer.combo.NTY3OA"])
    })
  })
  ...
  describe("onError", function () {
    ...
    it("triggers additional callbacks after join", function () {
      ...
      channel.trigger("combo_error", { reason: "channel_crash" })
  ...
  describe("push", function () {
    ...
    it("does not leak the reply binding of a buffered push", function () {
      ...
      const replyBindings = () =>
        channel.bindings.filter((b) => b.event.startsWith("chan_reply_"))
